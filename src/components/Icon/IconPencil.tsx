...
const IconPencil = ({ ...props }: ComponentProps<'svg'>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} fill="none" {...props}>
    <rect className="fill-primary-600" width={7.902} height={9.218} rx={2.491} transform="rotate(42.728 4.138 25.65)" />
    <g filter="url(#a)">
      <path
    ...
    <path className="fill-primary-600" d="M9.742 22.8 6.26 19.583l-.716 3.436a.658.658 0 0 0 .83.766l3.368-.985Z" />
    <defs>
      <filter
        id="a"
        width={19.803}
