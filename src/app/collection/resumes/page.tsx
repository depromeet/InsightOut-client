          ...
          <li>
            <div className="border rounded-[24px] hover:shadow-S4 p-[24px]">
              <header className="relative mb-[16px]">
                {/* 액션버튼 */}
                <b className="b4 mb-[5px]">2023. 04. 28 | 00:21 마지막 수정</b>
                {/* 자소서 문항 질문을 입력하지 않은 경우 -> ‘문항 질문을 적어보세요'로 제목이 보임 */}
                <h6 className="h6">텍스트를입력해주세요텍스트를입력해주세요텍스트를입력해주세요텍스트를입력해주세요</h6>
                <ActionList>
              ...
              <div>
                <b className="b2">
                  업무 개선을 통해 효율성을 높인 경험이 있습니다. 대학교에서 근로장학생으로, 교수님의 비대면 수업을
                  보조하는 업무를 맡았습니다. 당시 업무 체계는 교수님, 학생들의 민원이 발생할 때 교직원 선생님의 지시에
                  따라 해결했습니다. 민원이 동시에 발생해서 교직원 선생님의 지시가 불가능했을 때 적시에 해결하지 못하는
                  문제가 존재해서 업무 개선의 필요성을 느꼈습니다. 업무 개선을 통해 효율성을 높인 경험이 있습니다.
                  대학교에서 근로장학생으로, 교수님의 비대면 수업을 보조하는 업무를 맡았습니다. 당시 업무 체계는 교수님,
                  학생들의 민원이 발생할 때 교직원 선생님의 지시에 따라 해결했습니다. 민원이 동시에 발생해서 교직원
                  선생님의 지시가 불가능했을 때 적시에 해결하지 못하는 문제가 존재해서 업무 개선의 필요성을 느꼈습니다.
                  업무 개선을 통해 효지시에 따라 해결했습니다. 민원이 동시에 발생해서 교직원 선생님의 지시가 불가능했을
                  때 적시에 해결하지 못하는 문제가 존재해서 업무 개선의 필요성을 느꼈습니다. 업무 개선 효율성을
                  개선했습니다.
                </b>
              </div>
              <footer className="flex flex-row-reverse mt-[8px] ">
                <b className="b3 text-light">
                  <span className="text-secondary-500">1088자</span>/2000자
                </b>
              </footer>
            </div>
          </li>
