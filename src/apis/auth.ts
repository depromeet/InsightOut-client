...
import { InsightOutResponse } from '@/shared/@types/data/api';
...
const authApi = {
   ...
   */
  signIn: (idToken: string) => instance.post<string, InsightOutResponse<SignInData>>(AUTH_API.SIGN_IN, { idToken }),
  /**
   *
   * @description cookie에 담겨있는 refreshToken을 활용하여 accessToken 재발급
   */
  reIssue: () => instance.post<any, InsightOutResponse<AccessToken>>(AUTH_API.REISSUE),
};
